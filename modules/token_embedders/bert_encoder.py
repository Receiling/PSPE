...
class BertEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        if self.output_size > 0:
            self.mlp = BertLinear(input_size=self.bert_config.hidden_size,
    ...
    def forward(self, seq_inputs, token_type_inputs=None):
        ...
        outputs = self.bert_model(input_ids=seq_inputs,
...
class BertLinear(nn.Module):
    ...
    """
    def __init__(self, input_size, output_size, activation=nn.GELU(), dropout=0.0):
